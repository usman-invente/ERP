...
class ContactController extends Controller
{
    ...
    private function indexCustomer()
    {
        ...
        // $query = $this->contactUtil->getContactQuery($business_id, array('customer','lead'));
    ...
    public function saveContactInfo(Request $request){
        ...
        $contact->info_description = $request->contract_info;
        $contact->save();

        return back();
    }

    public function getAllContactsWithDobToday(){
        $business_id = request()->session()->get('user.business_id');

        $class_contact = new Contact();

        $view_values = [
            'class_contact' => $class_contact,
        ];

        $contacts = $class_contact->getBirthdayByCondition( $business_id, 'today');
        ...
        if (request()->ajax()) {
            ...
            $rawColumns = ['action', 'customer_name','birthday'];
        ...
        return view('contact.dob.today')->with($view_values);

    }

    public function getAllContactsWithDobThisWeek(){
        $business_id = request()->session()->get('user.business_id');
        ...
        $contacts = $class_contact->getBirthdayByCondition( $business_id, 'this_week');
        ...
        return view('contact.dob.this_week')->with($view_values);

    }

    public function getAllContactsWithDobThisMonth(){
        $business_id = request()->session()->get('user.business_id');
        ...
        $contacts = $class_contact->getBirthdayByCondition( $business_id, 'this_month');
        ...
        return view('contact.dob.this_month')->with($view_values);

    }

    public function getAllContactsWithDobNextMonth(){
        $business_id = request()->session()->get('user.business_id');
        ...
        $contacts = $class_contact->getBirthdayByCondition( $business_id, 'next_month');
        ...
        return view('contact.dob.next_month')->with($view_values);
