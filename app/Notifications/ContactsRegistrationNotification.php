...
class ContactsRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        // dd($this->notification_data->bussines_name);
        return (new MailMessage)                 
            ->subject('E-Mail Verifizieren für Registrierung bei der Firma "'.$data['bussines_name'].'"')
