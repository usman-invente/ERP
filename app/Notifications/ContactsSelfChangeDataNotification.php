...
class ContactsSelfChangeDataNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        // dd($data['bussines_name']);
        return (new MailMessage)
        ->subject('E-Mail Verifizieren für die Datenänderung bei der Firma "'.$data['bussines_name'].'"')
