...
class User extends Authenticatable
{
    ...
    public function first_location($business_id){
        if($this->permitted_locations() == "all"){
            $business_location = BusinessLocation::where('business_id','=', $business_id)
                                                ->first();
        }
        else{
            foreach (auth()->user()->permitted_locations() as $value) {
                // $value;break;
                $business_location = BusinessLocation::where('business_id','=', $value)
                                                ->first();
                break;
            }
        }
    ...
    public function getUserNameById($id){
        ...
        return $user ? trim("$user->surname $user->first_name $user->last_name") : null;
    }
}
