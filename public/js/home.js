...
function update_statistics(start, end) {
    ...
    $('.total_sell_netto').html(loader);
    $('.invoice_due').html(loader);
    $('.total_expense').html(loader);
    $('.total_purchase_return').html(loader);
    $('.total_sell_return').html(loader);
    $('.net').html(loader);
    $('.total_contracts_fee_monthly').html(loader);
    $('.total_contracts_discount').html(loader);
    $('.total_contracts_price_total').html(loader);
    $('.total_contracts_count').html(loader);
    $.ajax({
        method: 'get',
        url: '/home/get-totals',
        dataType: 'json',
        ...
        success: function(data) {
            ...
            $('.total_sell_netto').html(__currency_trans_from_en(data.total_sell_netto, true));
            ...
            $('.total_contracts_fee_monthly').html(__currency_trans_from_en(data.total_contracts_fee_monthly, true));
            $('.total_contracts_discount').html(__currency_trans_from_en(data.total_contracts_discount, true));
            $('.total_contracts_price_total').html(__currency_trans_from_en(data.total_contracts_price_total, true));
            $('.total_contracts_count').html((data.total_contracts_count));

            var total_contracts_detail = __currency_trans_from_en(data.total_contracts_price_total, true) + ' (' + data.total_contracts_count + ')';
            $('.total_contracts_detail').html(total_contracts_detail);
