      ...
      <tr>
        ...
        <td>
          {{-- <span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand }}</span> --}}
             <span class="display_currency" data-currency_symbol="true">{{ $cashRegisterUtil->getCloseAmountByCashRegisterDetailId($register_details->cash_register_detail_id) }}</span>
        </td>
        <td>--</td>
      </tr>
      <tr>
        ...
        <td>
          {{-- <span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand }}</span> --}}
             <span class="display_currency" data-currency_symbol="true">{{ $cashRegisterUtil->getIcomesSumByCashRegisterId($register_details->id, $register_details->cash_register_detail_id) }}</span>
        </td>
        <td>--</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cash_expense }} </span> ( @lang('expense.expenses') )
        </td> 
      </tr>
      {{--<tr>
        <td>
    ...
    <table class="table table-condensed">
      ...
      <tr class="danger">
        ...
        <td>
          ...
          <b><span class="display_currency" data-currency_symbol="true">{{ $sum_sells_return }}</span></b><br>
          <small>
      ...
      <tr class="success">
        <th>
          @lang('cash_register.cash_in_hand') +  @lang('cash_register.cash_payment')
        </th>
        <td>
          ...
          <b><span class="display_currency" data-currency_symbol="true">{{  $cashRegisterUtil->getCloseAmountByCashRegisterDetailId($register_details->cash_register_detail_id) + $register_details->total_cash - $register_details->total_cash_refund }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_cash  }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
      ...
      <tr class="success">
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $cashRegisterUtil->getIcomesSumByCashRegisterId($register_details->id, $register_details->cash_register_detail_id) }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
        ...
        <td>
          <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->total_card }}</span></b>
        </td>
      </tr>
      <tr class="success">
        <th>
