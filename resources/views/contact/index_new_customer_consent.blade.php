                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::date('dob', old('dob', null), ['class' => 'form-control dob-date-picker',  'placeholder' => __( 'lang_v1.dob' ) ]); !!}
                                @if ($errors->has('dob'))
                ...
                <div class="col-md-12">
                    <div class="table">                    
                        ...
                        <div calss="table-row">
                            ...
                            und 
                            <a href="{{ route('datenschutzerklaerung', ['business_id' => $business->id, 'location_id' => request()->route('location_id'), 'business_name' => $business_name]) }}" target="_blank">
                                <b>Datenschutzerklärung</b>
                            </a>
                            {{-- <a href="https://portal.neoburg.net/{{ request()->route("business_id") }}/{{ request()->route("location_id") }}/{{ request()->route("business_name")}}/{{ $first_name }}/vollmacht" target="_blank"><b>Vollmacht zur Datenspeicherung</b></a> 
                            übertragen werden. --}}
                        </div>
                    </div>
                </div>
                    ...
                    {{-- <input type="checkbox" id="consent_field1" /> --}}
                        {!! Form::checkbox('consent_field1', 1, false, [ 'name'=>'consent_field1','id' => 'consent_field1']); !!} 
                            Ich bestätige hiermit, dass ich die 
                                <a href="{{ route('einwilligungen', ['business_id' => $business->id, 'location_id' => request()->route('location_id'), 'business_name' => $business_name]) }}">
                                    <b>Einwilligungserklärung</b>
                                </a>
                ...
                <div class="form-group">
                    <label>
                        {!! Form::checkbox('consent_field3', 1, false, [ 'name'=>'consent_field3','id' => 'consent_field3']); !!} 
                            <strong>@lang('lang_v1.consent_field3')</strong>
