<script>
    ...
    function displayRadioValue() {
        ...
        if(document.getElementById("inlineRadio2").checked ){
            document.getElementById("supplier_business_name").readOnly = false;
            document.getElementById("business_position").readOnly = false;
        }else{
             document.getElementById("supplier_business_name").readOnly = true;
             document.getElementById("supplier_business_name").value = null;
    ...
    <div class="modal-body">
        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  null, ['class' => 'form-control', 'readonly', 'placeholder' => __('business.business_name')]); !!}
        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  {!! Form::text('business_position', 
                  null, ['class' => 'form-control', 'readonly', 'placeholder' => __('business.business_position')]); !!}
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {{-- <input type="checkbox" id="consent_all" onclick="javascript:checkAll(this)"/> --}}
                        {!! Form::checkbox('consent', 1, false, ['class' => 'input-icheck', 'id' => 'consent', 'onclick=javascript:checkAll(this)']); !!} 
        ...
        <div class="clearfix"></div>
            ...
            @php
              ...
              $contact_custom_field1 = !empty($custom_labels['contact']['custom_field_1']) ? $custom_labels['contact']['custom_field_1'] : __('lang_v1.crm_custom_field1');
              $contact_custom_field2 = !empty($custom_labels['contact']['custom_field_2']) ? $custom_labels['contact']['custom_field_2'] : __('lang_v1.crm_custom_field2');
              $contact_custom_field3 = !empty($custom_labels['contact']['custom_field_3']) ? $custom_labels['contact']['custom_field_3'] : __('lang_v1.crm_custom_field3');
              $contact_custom_field4 = !empty($custom_labels['contact']['custom_field_4']) ? $custom_labels['contact']['custom_field_4'] : __('lang_v1.crm_custom_field4');
            ...
            <div class="col-md-10 text-red">
                <b>Bitte beachten Sie, dass bei manueller Eingabe von Kontaktdaten und Einwilligungserklärungen eine schriftliche Bestätigung 
                erforderlich ist. Sie können unsere Vorlage unter <a href="https://www.neoburg.net/druckvorlagen/" target="_blank">NEOBURG.net </a>herunterladen und hochladen, 
                um diesen Prozess zu vereinfachen.</b>
            </div>
            {{-- <div class="col-md-3">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" class="larger" name="consent" value="0">
                            <b> @lang('crm::lang.consent')</b>
                            @show_tooltip(__('crm::lang.consent'))
                        </label>
                    </div>
                </div>
            </div> 
            <div class="col-md-3">
                <div class="form-group">
                    <label>
                        {!! Form::checkbox('consent', 1, false, ['class' => 'input-icheck', 'id' => 'newsletter_active']); !!} <strong>@lang('crm::lang.consent')</strong>
                    </label>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label>
                        {!! Form::checkbox('newsletter_active', 1, false, ['class' => 'input-icheck', 'id' => 'newsletter_active']); !!} <strong>@lang('crm::lang.newsletter_active')</strong>
                    </label>
                </div>
            </div>--}}
        </div>
