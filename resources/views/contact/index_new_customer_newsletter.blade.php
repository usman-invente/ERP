                ...
                {{-- <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('street',  old('street', null) , ['class' => 'form-control', 'placeholder' => __( 'business.street' ) ]); !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('house_nr', old('house_nr', null), ['class' => 'form-control',  'placeholder' => __( 'business.house_nr' ) ]); !!}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('zip_code', old('zip_code', null), ['class' => 'form-control',  'placeholder' => __( 'business.zip_code' ) ]); !!}
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('city', old('city', null), ['class' => 'form-control', 'placeholder' => __( 'business.city' ) ]); !!}
                            @if ($errors->has('city'))
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('country', old('country', null), ['class' => 'form-control',  'placeholder' => __( 'business.country' ) ]); !!}
