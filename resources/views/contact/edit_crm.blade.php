      ...
      <div class="row">
        ...
        <div class="col-md-4 mt-15">
            <label class="radio-inline">
                <input {{ $individual_checked }} onclick="displayRadioValue()"  type="radio" name="contact_type_radio" id="inlineRadio1" value="individual">
                @lang('lang_v1.individual')
            </label>
            <label class="radio-inline">
                <input {{ $business_checked }} onclick="displayRadioValue()" type="radio" name="contact_type_radio" id="inlineRadio2" value="business">
        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  $contact->supplier_business_name, ['class' => 'form-control', $business_disabled, 'placeholder' => __('business.business_name')]); !!}
              </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  $contact->business_position, ['class' => 'form-control', $business_disabled, 'placeholder' => __('business.business_position')]); !!}
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::email('email', $contact->email, ['class' => 'form-control', 'required', 'disabled', 'placeholder' => __('business.email')]); !!}
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('dob', !empty($contact->dob) ? @format_date($contact->dob) : null, ['class' => 'form-control dob-date-picker', 'disabled', 'placeholder' => __('lang_v1.dob'), 'readonly']); !!}
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {{-- <input type="checkbox" id="consent_all" onclick="javascript:checkAll(this)"/> --}}
                        {!! Form::checkbox('consent', 1, $contact->consent, ['class' => 'input-icheck', 'id' => 'consent', 'onclick=javascript:checkAll(this)']); !!} 
