                    ...
                    @if (auth()->user()->can('dashboard.data'))
                            <div class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-6 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5">
                                <div
                                    ...
                                    <a href="{{ route('contracts_details') }}" target="_blank">
                                        <div class="tw-p-4 sm:tw-p-5">
                                            <div class="tw-flex tw-items-center tw-gap-4">
                                                <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-blau-700">
                                                    <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <path d="M6 8h6" />
                                                        <path d="M6 16h2" />
                                                        <path d="M18 4h-12a2 2 0 0 0 -2 2v16" />
                                                        <path d="M18 4v4a2 2 0 0 0 2 2h4" />
                                                    </svg>
                                                </div>
                                                ...
                                                <div class="tw-flex-1 tw-min-w-0">
                                                    <p
                                                        ...
                                                        {{ __('contract.contracts_details') }}
                                                    </p>
                                                    {{-- <button>
                                                        <span class="info-box-number">{!! $number_of_this_week !!}</span> 
                                                    </button> --}}
                                                    <p
                                                        class="total_contracts_detail tw-mt-0.5 tw-text-gray-900 tw-text-xl tw-truncate tw-font-semibold tw-tracking-tight tw-font-mono">
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        {{-- @if ($is_admin) --}}
                            @if(($active_subscription->package_id != 14) )
                                <div class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-6 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5">
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contracts_this_week') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-yellow-500">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                            stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contracts_this_month') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-green-500">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                            stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        <p
                                                            class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                                            {{ __('home.contract_this_month') }}
                                                        </p>
                                                        <button>
                                                            <span class="info-box-number">{!! $number_of_this_month !!}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contracts_overdue') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-red-500">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                            stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        <p
                                                            class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                                            {{ __('home.contract_overdue') }}
                                                        </p>
                                                        <button>
                                                            <span class="info-box-number">{!! $number_of_overdue !!}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contracts_next_month') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-yellow-400">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                                            stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        <p
                                                            class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                                            {{ __('home.contract_next_month') }}
                                                        </p>
                                                        <button>
                                                            <span class="info-box-number">{!! $number_of_next_month !!}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tw-grid tw-grid-cols-1 tw-gap-4 tw-mt-6 sm:tw-grid-cols-2 xl:tw-grid-cols-4 sm:tw-gap-5">
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contact_dob_today') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-yellow-500">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path d="M16 3v3" />
                                                            <path d="M8 3v3" />
                                                            <path d="M4 10h16v4a4 4 0 0 1 -4 4h-8a4 4 0 0 1 -4 -4v-4z" />
                                                            <path d="M4 14c3 3 7 3 10 0" />
                                                            <path d="M14 14c3 3 7 3 10 0" />
                                                        </svg>
                                                    </div>
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        ...
                                                        <button>  
                                                            <span class="info-box-number">{{ $number_dobs_today }}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contact_dob_this_week') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-green-500">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        <p
                                                            class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                                            {{ __('home.dobs_this_week') }}
                                                        </p>
                                                        <button>
                                                            <span class="info-box-number">{!! $number_dobs_this_week !!}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contact_dob_this_month') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    <div class="tw-inline-flex tw-items-center tw-justify-center tw-w-10 tw-h-10 tw-rounded-full sm:tw-w-12 sm:tw-h-12 tw-shrink-0 tw-bg-sky-100 tw-text-red-500">
                                                        <svg aria-hidden="true" class="tw-w-6 tw-h-6" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        <p
                                                            class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                                            {{ __('home.dobs_this_month') }}
                                                        </p>
                                                        <button>
                                                            <span class="info-box-number">{!! $number_dobs_this_month !!}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        class="tw-transition-all tw-duration-200 tw-bg-white tw-shadow-sm hover:tw-shadow-md tw-rounded-xl  tw-ring-1 tw-ring-gray-200">
                                        <a href="{{ route('contact_dob_next_month') }}" target="_blank">
                                            <div class="tw-p-4 sm:tw-p-5">
                                                <div class="tw-flex tw-items-center tw-gap-4">
                                                    ...
                                                    <div class="tw-flex-1 tw-min-w-0">
                                                        <p
                                                            class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                                                            {{ __('home.dobs_next_month') }}
                                                        </p>
                                                        <button>
                                                            <span class="info-box-number">{!! $number_dobs_next_month !!}</span> 
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
...
@section('javascript')
    ...
    <script src="{{ asset('js/home.js?v=' . now()->format('Ymd')) }}"></script>
