...
<script>
    function showContactInfo() {
		...
		let show= document.getElementById("customer_id");
...
<div class="modal fade contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
	@include('contact.create_crm', ['quick_add' => true])
</div>
@if(empty($pos_settings['hide_product_suggestion']) && isMobile())
...
<div class="modal fade" id="income_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
</div>
