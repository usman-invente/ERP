        ...
        <div class="ticket">
            ...
            <table style="margin-top: 25px !important" class="border-bottom width-100 table-f-12 mb-10">
                <thead class="border-bottom-dotted">
                    <tr>
						...
						@endif
						<th class="text-right">{{$receipt_details->line_tax_label}}</th>
			...
			@if(empty($receipt_details->hide_price))
				...
				@if(!empty($receipt_details->total_get_money_cash))
						<div class="flex-box">
							<p class="width-50 text-right">
								@lang('lang_v1.get_money_cash')
							</p>
							<p class="width-50 text-right">
								{{$receipt_details->total_get_money_cash}}
							</p>
						</div>
						<div class="flex-box">
							<p class="width-50 text-right">
								@lang('lang_v1.return_money')
							</p>
							<p class="width-50 text-right">
								{{$receipt_details->total_return_money}}
							</p>
						</div>
				@endif
