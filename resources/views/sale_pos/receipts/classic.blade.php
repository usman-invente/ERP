		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					...
					@endif
					<th class="text-right" width="15%">{{$receipt_details->line_tax_label}}</th>
			...
			<tbody>
				@forelse($receipt_details->lines as $line)
					<tr>
						...
						@endif
						<td class="text-right">
							{{ number_format(str_replace(",", ".", $line['quantity'])  * str_replace(",", ".", $line['tax']), 2, ",", ".")}} 
	...
	<div class="col-xs-6">
		...
		<table class="table table-slim">
			...
			@if(!empty($receipt_details->payments))
				...
				@endforeach
			@endif
			@if(!empty($receipt_details->total_get_money_cash))
					<tr>
						<td>@lang('lang_v1.get_money_cash')</td>
						<td class="text-right" >{{$receipt_details->total_get_money_cash}}</td>
					</tr>
					<tr>
						<td>@lang('lang_v1.return_money')</td>
						<td class="text-right" >{{$receipt_details->total_return_money}}</td>
					</tr>
			@endif
        ...
        <div class="table-responsive">
          	<table class="table table-slim">
				<tbody>
					...
					@endif
					@php
						$last_val = !empty($receipt_details->taxes) ? end($receipt_details->taxes) : 0;						
					@endphp
					<tr>
						<th style="width:70%">
						...
						<td class="text-right">
							{{ number_format(($receipt_details->subtotal)  -  ($last_val), 2, ",", ".")}} 
