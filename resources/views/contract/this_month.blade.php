...
@component('components.widget', ['class' => 'box-primary', 'title' => __('contract.contract_this_month')])
      
		    <table class="table table-bordered table-striped" id="contract_this_month_table" style="width: 80%">
                <thead>
                    <tr>
...
@section('javascript')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
                    ...
                    $('#contract_this_month_table thead tr').clone(true).appendTo( '#contract_this_month_table thead' );
					$('#contract_this_month_table thead tr:eq(0) th').each( function (i) {
						var title = $(this).text();
        			    if(i == 0 ){
        			       $(this).html( '<td/>' ); 
        			    }
                    ...
                    contract_modul_datatable = $("#contract_this_month_table").DataTable({
	        			processing: true,
	        	        serverSide: true,
