...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        @php
            $diff_price_total = 0;
        @endphp
        {!! Form::open(['url' => action([\App\Http\Controllers\ContractController::class, 'store']), 'method' => 'post']) !!}
         <input type="hidden" name="url_previous" value="{{url()->previous()}}" id="url_previous">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title" id="myModalLabel">
                    @lang('contract.add_contract')
                </h4>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::text('connected_to_number', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::text('contract_feld1', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('contract_feld2', __('contract.contract_feld2') . ':' )!!}
                            {!! Form::text('contract_feld2', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('contract_feld3', __('contract.contract_feld3') . ':' )!!}
                            {!! Form::text('contract_feld3', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::date('contract_start_date', null, ['class' => 'form-control', 'id'=> 'PMDate', 'name'=>'PMDate']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('contract_duraction', __('contract.contract_duraction') . ':' )!!}
                            {!! Form::text('contract_duraction', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('contract_end_date', __('contract.contract_end_date') . ':' )!!}
                            {!! Form::date('contract_end_date', null, ['class' => 'form-control', 'id'=>'NPMDate', 'name'=>'NPMDate', 'readonly']) !!}
                       </div>
                    </div>
                </div>                
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::text('contact_before_end_of_contract', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('date_to_contact', __('contract.date_to_contact') . ':' )!!}
                            {!! Form::date('date_to_contact', null, ['class' => 'form-control', 'id'=>'ConDate', 'name'=>'ConDate', 'readonly']) !!}
                       </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::text('contract_feld4', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('contract_feld5', __('contract.contract_feld5') . ':' )!!}
                            {!! Form::text('contract_feld5', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::text('fee_monthly', null, ['class' => 'form-control', 'id' =>'fee_monthly', 'onchange=javascript:findPriceTotal()']) !!}
                       </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                       <div class="form-group">
                            ...
                            {!! Form::text('discount', null, ['class' => 'form-control', 'id' =>'discount', 'onchange=javascript:findPriceTotal()']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('contract_feld6', __('contract.contract_feld6') . ':' )!!}
                            {!! Form::text('contract_feld6', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                    <div class="col-md-4">
                       <div class="form-group">
                            {!! Form::label('discount_duraction', __('contract.discount_duraction') . ':' )!!}
                            {!! Form::text('discount_duraction', null, ['class' => 'form-control']) !!}
                       </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('contract_info', null, ['class' => 'form-control ', 'id' => 'description']); !!}
                        </div>
                    </div>
                </div>
                {{-- <div class="row">
