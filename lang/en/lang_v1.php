...
return [
    ...
    'crm_import_contact_type_ins' => 'Available Options: <strong><br> 1 = Customer</strong>',
    ...
    "consent_as_text" => "Consent",
    "consent_all" => "Select all",
    "consent_email" => "E-Mail",
    "consent_mobile" => "Phone",
    "consent_post" => "Post",
    "consent_messenger" => "Messenger",
    "consent_field1" => "Declaration of consent has been read",
    "consent_field2" => "Power of Attorney Inspection and storage of documents and contracts",
    "consent_field3" => "Authorization terms read",
    "consent_field4" => "Consent to use the data my payment service provider",
    "consent_field5" => "Consent to the use of my payment service provider's data for the above purpose",
    "logo_size" => "W500px H500px",
    "last_change_consent" => "Last change consent",
    "last_consent_date" => "Last change consent date",
    "last_consent_from" => "Last change consent from",
    "opt_out" => "delete all",
    "link_self_edit_data" => "Link to change Data",
    'radio_button_choose' => 'Optionen: <strong> <br> 1 = Yes, <br> 2 = No</strong>',
    'documents_and_notes_permissions_tooltip' => 'That ist only for packege "CRM PRO". You can use it for free, only for 30 days!',
    'revocation' => 'Revocation',
    'list_of_registration' => 'List of all partners',
    'data_change_or_delete' => 'Data change/delete',
    'vollmacht' => 'Vollmacht',
