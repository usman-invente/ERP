...
return [
    ...
    'instruction_line2' => 'Die Spalten der CSV/XLS-Datei sollten in der folgenden Reihenfolge sein.',
    ...
    'quotation_heading' => 'Angebot Überschrift',
    'quotation' => 'Angebot',
    'quotation_no_prefix' => 'Angebot Nr. Etikette',
    'tooltip_quotation_heading' => 'Die Überschrift Angebot oder Schätzungen wird verwendet, während den Kunden ein Angebot unterbreitet wird.',
    ...
    '12_hour' => '12 Stunden',
    '24_hour' => '24 Stunden',
    'list_quotations' => 'Angebote auflisten',
    ...
    'design' => 'Design',
    'express_checkout_cash' => 'Bar',
    'get_money_cash' => 'Bekommen im Bar',
    'return_money' => 'Restgeld',
    ...
    'save_n_add_selling_price_group_prices' => 'Speichern und Hinzufügen von Verkaufspreisgruppenpreisen',
    ...
    'notification_templates' => 'Mail (folgt)',
    ...
    'select_base_unit' => 'Basiseinheit auswählen',
    'times_base_unit' => 'mal Basiseinheit',
    'multi_unit_help' => 'Definieren Sie diese Einheit als das Vielfache anderer Einheiten <br><strong>Zb.: 1 Dutzend = 12 Stück</strong>',
    'add_as_multiple_of_base_unit' => 'Hinzufügen als Vielfaches der anderen Einheit',
    ...
    'custom_labels' => 'Benutzerdefinierte Felder',
    ...
    'crm_import_contact_type_ins' => 'Verfügbare Optionen: <strong> <br> 1 = Kunde</strong>',
    ...
    'notifications' => 'Benachrichtigungsvorlagen',
    ...
    'labels_for_contact_custom_fields' => 'Benutzerdefinierte Felder',
    ...
    'view_quote_url' => 'Angebot-URL anzeigen',
    ...
    "crm_custom_field1" => "Sprache",
    "crm_custom_field2" => "Relegion",
    "crm_custom_field3" => "Benutzerdefiniertes Feld 3",
    "crm_custom_field4" => "Benutzerdefiniertes Feld 4",
    "consent_as_text" => "Einwilligung",
    "consent_all" => "Alle auswählen",
    "consent_email" => "E-Mail",
    "consent_mobile" => "Telefon",
    "consent_post" => "Post",
    "consent_messenger" => "Messenger",
    "consent_field1" => "Einwilligungserklärung ",
    "consent_field2" => "Vollmacht Einsicht und Speicherung Dokumente und Verträge",
    "consent_field3" => "Vollmacht-Einwilligung",
    "consent_field4" => "Einwilligung zur Nutzung der Daten meiner Zahlungsdienstleister",
    "consent_field5" => "Einwilligung Zahlungsdienstleister",
    "customer_complete_registration" => "Messenger",
    "logo_size" => "B500px H500px",
    "last_change_consent" => "Letzte Änderung den Einwilligungen",
    "last_consent_date" => "Datum der letzen Änderung den Einwilligungen",
    "last_consent_from" => "Letzte Änderung den Einwilligungen von",
    "opt_out" => "Alles löschen",
    "link_self_edit_data" => "Link, um die Daten zu ändern",
    'radio_button_choose' => 'Optionen: <strong> <br> 1 = Ja, <br> 2 = Nein</strong>',
    'documents_and_notes_permissions_tooltip' => 'Dokumente ist Teil des CRM PRO Paket. Sollte Sie dies über den 31.07.2023 nutzen wollen, führen Sie Ende Juli ein Upgrade durch.',
    'contracts_tooltip' => 'Verträge ist Teil des CRM PRO Paket. Sollte Sie dies über den 31.07.2023 nutzen wollen, führen Sie Ende Juli ein Upgrade durch.',
    'revocation' => 'Wiederruf',
    'list_of_registration' => 'Auflistung aller Partner',
    'data_change_or_delete' => 'Daten ändern/ löschen',
    'vollmacht' => 'Vollmacht',
    'payment_service' => 'Zahlungsdienstleister',
    'bank' => 'Bank',
    'iban' => 'IBAN',
    'bic' => 'BIC',
    'paypal' => 'Paypal',
    'modul_name_reminder' => 'Reminder Buddy',
    'cash_register_deposits' => 'Kasse Einzahlungen',
	'welcome_back' => 'Willkommen zurück',
	'login_to_your' => 'Login zu Ihre',
    'payable' => 'Summe',
    'signed_in_as' => 'Angemeldet als',
    'update_product_price' => 'Produktpreis bearbeiten',
    'in_stock' => 'In Lager',
