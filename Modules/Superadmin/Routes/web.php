...
Route::middleware('web', 'auth', 'language', 'AdminSidebarMenu', 'superadmin')->prefix('superadmin')->group(function () {
    ...
    Route::get('/business/{id}/subscriptions/{sub_id}/edit', [Modules\Superadmin\Http\Controllers\BusinessController::class, 'edit_subscription'])->name('business.edit_subscription');
    Route::put('/business/{id}/subscriptions/{sub_id}', [Modules\Superadmin\Http\Controllers\BusinessController::class, 'update_subscription'])->name('business.update_subscription');
    Route::delete('/business/{id}/subscriptions/{sub_id}', [Modules\Superadmin\Http\Controllers\BusinessController::class, 'destroy_subscription'])->name('business.destroy_subscription');
