                ...
                <div class="tw-flex tw-flex-col tw-items-center">
                    ...
                    <div class="tw-flex tw-flex-col tw-gap-2 tw-text-center">
                        ...
                        <h3 class="tw-text-sm tw-font-medium tw-text-white">
                            @lang('superadmin::lang.choose_your_prefered') {{ config('app.name', 'ultimatePOS') }} @lang('superadmin::lang.pricing_plan')
                        </h3>
                    </div>
                    <!-- Montly/annual-->
                    <div class="tw-flex tw-gap-2 mt-5 md:tw-mt-5">
                        ...
                        <span class="tw-flex tw-flex-col tw-text-white"> @lang('superadmin::lang.yearly') </span>
                    </div>
                </div>
