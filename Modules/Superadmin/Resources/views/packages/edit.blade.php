                    ...
                    <div class="tw-mx-4 tw--my-2-auto sm:tw--mx-5">
                        <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('consent_dsgvo', 1, !empty($as_json_more_info_for_package['consent_dsgvo']), ['class' => 'input-icheck']) !!}
                                        {{ __('superadmin::lang.consent_dsgvo') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('reminder_function', 1, !empty($as_json_more_info_for_package['reminder_function']), ['class' => 'input-icheck']) !!}
                                        {{ __('superadmin::lang.reminder_function') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('birthday', 1, !empty($as_json_more_info_for_package['birthday']), ['class' => 'input-icheck']) !!}
                                        {{ __('superadmin::lang.birthday') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('contract_extension', 1, !empty($as_json_more_info_for_package['contract_extension']), ['class' => 'input-icheck']) !!}
                                        {{ __('superadmin::lang.contract_extension') }}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3 ">
