                    ...
                    <div class="tw-mx-4 tw--my-2-auto sm:tw--mx-5">
                        <div class="tw-inline-block tw-min-w-full tw-py-2 tw-align-middle sm:tw-px-5">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('consent_dsgvo', 1, true, ['class' => 'input-icheck']) !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('reminder_function', 1, true, ['class' => 'input-icheck']) !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('birthday', 1, true, ['class' => 'input-icheck']) !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        {!! Form::checkbox('contract_extension', 1, true, ['class' => 'input-icheck']) !!}
