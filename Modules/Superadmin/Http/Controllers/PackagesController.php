...
class PackagesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data = [
                'consent_dsgvo' => request()->has('consent_dsgvo') ? 1 : 0,
                'reminder_function' => request()->has('reminder_function') ? 1 : 0,
                'birthday' => request()->has('birthday') ? 1 : 0,
                'contract_extension' => request()->has('contract_extension') ? 1 : 0,
                'mark_package_as_popular' => request()->has('mark_package_as_popular') ? 1 : 0,
            ];

            $input['more_info_for_package'] = json_encode($data);
    ...
    public function edit($id)
    {
        ...
        $as_json_more_info_for_package = is_array($packages->more_info_for_package)
        ? $packages->more_info_for_package
        : json_decode($packages->more_info_for_package, true);
        ...
        return view('superadmin::packages.edit')
               ->with(compact('packages', 'intervals', 'permissions', 'businesses','as_json_more_info_for_package'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $packages_details['more_info_for_package'] = json_encode($data);
