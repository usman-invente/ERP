@extends('layouts.app')
@section('title', __( 'dynamicqrcode::lang.generate_new_qr_code' ))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><i class="fa fas fa-qrcode"></i> @lang( 'dynamicqrcode::lang.generate_new_qr_code' )</h1>
</section>
@php
...
<section class="content">
    <div class="row">
        <div class="col-md-7">
            {!! Form::open(['url' => action([\Modules\DynamicQrCode\Http\Controllers\DynamicQrCodeController::class, 'store']), 'method' => 'post' ]) !!}
    	@component('components.widget', ['class' => 'box-solid'])
            ...
            <div class="form-group">
                ...
                {!! Form::text('redirect', null, ['class' => 'form-control', 'id' =>'redirect', 'required', 'placeholder' => __( 'dynamicqrcode::lang.placeholder_redirect' ) ]); !!}
            </div>
            <div class="form-group">
                {!! Form::label('title', __('dynamicqrcode::lang.title').':') !!}
                {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'title', 'name' => 'title', 'placeholder' => __( 'dynamicqrcode::lang.placeholder_title' ) ]); !!}
            </div>
            {{-- <div class="form-group">
                {!! Form::label('link', __('dynamicqrcode::lang.link').':') !!}
                {!! Form::text('link', null, ['class' => 'form-control', 'placeholder' => __( 'dynamicqrcode::lang.link' ) ]); !!}
            </div> --}}
            <div class="form-group">
