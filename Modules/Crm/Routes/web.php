...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin')->prefix('crm')->group(function () {
    ...
    Route::get('customer-import', [Modules\Crm\Http\Controllers\LeadController::class, 'getImportCrmContacts'])->name('crm.customer-import');
    Route::post('customer-import', [Modules\Crm\Http\Controllers\LeadController::class, 'postImportCrmContacts']);
