...
class CrmUtil extends Util
{
    ...
    // public function addContract($input, $contact_id, $max_nr){
    //     $input['contact_id'] = $contact_id;
    //     $input['number'] = $max_nr + 1;
    ...
    public function getLeadsListQuery($business_id)
    {
        $leads = CrmContact::with(['Source', 'lifeStage', 'leadUsers'])
                ...
                ->whereIn('contacts.type', ['lead', 'customer'])
                ...
                'address_line_2', 'street', 'house_nr', 'city', 'state', 'country', 'zip_code',
                'contacts.prefix', 'contacts.first_name', 'contacts.middle_name', 'contacts.last_name','contacts.business_position',
                'contacts.consent_email','contacts.consent_mobile','contacts.consent_post','contacts.consent_messenger',
