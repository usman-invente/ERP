    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary'])
                {!! Form::open(['url' => action([\Modules\Crm\Http\Controllers\LeadController::class, 'postImportCrmContacts']), 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    <div class="row">
                        <div class="col-sm-6">
                        <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="{{ asset('files/crm_import_customer_csv_template.xls') }}" class="btn btn-success" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                    </div>
                </div>
            @endcomponent
        </div>
            ...
            @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>{!! __('lang_v1.crm_import_contact_type_ins') !!}</td>
                    </tr>
                    <tr>
                        <td>2</td>
                    ...
                    <tr>
                        <td>5</td>
                        <td>@lang('business.title') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>6</td>
                        <td>@lang('business.business_name') <br><small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>7</td>
                        <td>@lang('business.business_position') <br><small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>8</td>
                    ...
                    <tr>
                        <td>10</td>
                        <td>@lang('contact.mobile') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>11</td>
                        <td>@lang('lang_v1.consent_as_text') @lang('lang_v1.consent_email') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                        <td>{!! __('lang_v1.radio_button_choose') !!}</td>
                    </tr>
                    <tr>
                        <td>13</td>
                        <td>@lang('lang_v1.consent_as_text') @lang('lang_v1.consent_mobile') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                        <td>{!! __('lang_v1.radio_button_choose') !!}</td>
                    </tr>
                    <tr>
                        <td>13</td>
                        <td>@lang('lang_v1.consent_as_text') @lang('lang_v1.consent_post') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                        <td>{!! __('lang_v1.radio_button_choose') !!}</td>
                    </tr>
                    <tr>
                        <td>14</td>
                        <td>@lang('lang_v1.consent_as_text') @lang('lang_v1.consent_messenger') <small class="text-muted">(@lang('lang_v1.required'))</small></td>
                        <td>{!! __('lang_v1.radio_button_choose') !!}</td>
                    </tr>
                    <tr>
                        <td>15</td>
                        <td>@lang('business.street') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>16</td>
                        <td>@lang('business.house_nr') <small class="text-muted">(@lang('lang_v1.optional'))</small></td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>17</td>
