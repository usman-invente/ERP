@extends('layouts.app')
@section('title', __( 'productcatalogue::lang.newsletter_generate_qr' ))
...
<section class="content-header">
    <h1></i> @lang( 'productcatalogue::lang.newsletter_generate_qr' )</h1>
</section>
@php
...
<section class="content">
    <div class="row">
    	...
    	@component('components.widget', ['class' => 'box-solid'])
            ...
            {{-- <input hidden type="text" name="qr_link" id="qr_link" value='{{ $qr_link }}' > --}}
...
<script type="text/javascript">
    ...
    $(document).on('click', '#generate_qr', function(e){
        $('#qrcode').html('');
        if ($('#location_id').val()) {
            var link = "https://neoburg.net/redirect_qr_code";
            var link = "{{url('crm-new-customer-newsletter/'. session('business.id'))}}/" + $('#location_id').val()+"/" + $('#business_n').val();
            var color = '#000000';
            if ($('#color').val().trim() != '') {
                color = $('#color').val();
            }
